...
def main():
    ...
    def L4init(): # Adds the tournament page to the main section.
        L4.flush() # This function is called when the player clicks the "Let's find out!" button.
        ...
        L4v.stepno = 0
        def add_index1(): # This function is called when the player clicks the "Let's find out!" button.
            L4.flush()
        ...
        def L4last(betc): # This function is called when the player clicks the "Let's find out!" button.
            L4.flush()
        ...
        def L4step(betc): 
            L4.flush()
            for i in range(L4v.stepno+1,5): # This loop calculates the scores for each character.
            ...
            if L4v.stepno<3: # This if-else statement adds the "NEXT" button to the page.
            ...
            L4v.stepno+=1
        def L4resp(resp): # This function is called when the player makes a bet.
            L4.flush()
    ...
    def L5init(): # Adds the making mistaeks page to the main section.
        L5v = back.TempValues() 
        L5v.stepno = 0        
        def L5next(): # This function is called when the player clicks the "NEXT" button.
            L5.flush() 
            L5v.stepno+=1
            if L5v.stepno==1: # This if-else statement adds the "NEXT" button to the page.
    ...
    def L6init(): # Adds the tournament page to the main section.
        L6.flush()
        L6v = back.TempValues()
        ...
        L6v.playlist = []
        L6v.playactive = 1
        # The follwoinf function are called when the player clicks the "Let's find out!" button.
        def L6reset(): 
        ...
        def ginc(gg,factor): 
            if gg==0:
                ...
                if (1<=L6v.get_coin+factor<=5):
                    L6v.get_coin+=factor
        def L6step():  
            Scores,L6v.playlist = multitourney(L6v.charlist,L6v.err,L6v.playlist,L6v.give_coin,L6v.get_coin) # This function calculates the scores for each character.
        ...
        def L6play(): 
            ...
            L6v.playactive = 0
        def L6replace(): 
            for i in range(L6v.eln): # This loop replaces the worst players with the best players.
            ...
            for i in range(L6v.eln): # This loop replaces the best players with the worst players.
        ...
        def change_tab(tab): 
            L6v.active_tab = tab
            L6.flush() 
            if tab==0: # This if-else statement adds the "NEXT" button to the page.
    ...
    def L7init(): # Adds the sandbox mode page to the main section.
        L7v = back.TempValues()
        L7v.activeplayer = "copycat"
        L7v.steplist = [[],[]]
        L7v.scorelist = [0,0]
        L7v.godv = GodSet(L7v.activeplayer)
        def L7step(): # This function is called when the player clicks the "STEP" button.
            r1 = L7v.godv.godstep()
        ...
        def L7reset(setplayer=None): # This function is called when the player clicks the "RESET" button.
            L7.flush()
            L7v.steplist = [[],[]]
            L7v.scorelist = [0,0]
            if setplayer:
    ...
    def L8init(): # Adds the conclusion page to the main section.
        L8.flush() # This function is called when the player clicks the "Conclude" button.
        # The following functions are called when " Next" button is clicked. 
        def L8next(): 
            L8.flush()
